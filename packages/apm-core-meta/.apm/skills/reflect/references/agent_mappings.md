...
|--------------|---------------|---------------|
| Git workflow | `AGENTS.md`         | Commit hygiene section |
...
| Terminology       | `AGENTS.md`               | Glossary section         |
| Constraints       | Project-specific agent    | Validation rules         |
| User requirements | `AGENTS.md`               | User preferences section |
...
**Mapping**:
- Primary: `~/.gemini/agents/universal/frontend-developer.md`
...
**Mapping**:
- Primary: `~/.gemini/agents/engineering/api-architect.md`
...
**Mapping**:
- Primary: `~/.gemini/agents/engineering/security-agent.md`
- Section: `## Validation Rules`
- Addition: `* Always validate inputs server-side; client validation is for UX only`
- Secondary: `~/.gemini/agents/engineering/code-reviewer.md`
...
**Mapping**:
- Create: `.agents/skills/react-hydration-mismatch-fix/SKILL.md`
