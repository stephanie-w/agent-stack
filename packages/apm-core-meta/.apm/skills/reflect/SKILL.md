---
name: reflect
description: Self-improvement skill that extracts learnings from corrections and success patterns to permanently evolve agent definitions and capabilities.
applyTo: "*"
---
...
| ---------- | -------------------- | ------------------------------------------------------- |
| **HIGH**   | Explicit corrections | "never", "always", "wrong", "stop", "the rule is", "no" |
...
| Process      | `AGENTS.md`, orchestrator agents                               |
| Domain       | Domain-specific agents, `AGENTS.md`                            |
| Tools        | `AGENTS.md`, relevant specialists                              |
...
- `.reflect/logs/reflections/YYYY-MM-DD_HH-MM-SS.md` - Full reflection
- `.reflect/skills/{name}/SKILL.md` - New skills
